...
if (_deduped.length < 1024) {
  ...
  const _extras = [
    ...
    "llama", "lofty", "lucid", "lunar", "lusty", "manga", "manor", "marsh",
    "mason", "maxim", "mayor", "melon", "mercy", "mirth", "mocha", "mogul",
    "mural", "nacho", "nerve", "newts", "ninny", "noble", "novel", "nudge",
    "oaken", "occur", "omega", "onset", "otter", "ovary", "oxide", "panda",
    "panic", "patch", "pesto", "pixel", "plaid", "plumb", "pouch", "prawn",
    "quota", "rabbi", "ramen", "raven", "recap", "reign", "rinse", "roast",
    "rugby", "rumba", "sauna", "scone", "shawl", "shrub", "sigma", "siren",
    "snowy", "squid", "stork", "tabby", "thyme", "topaz", "trout", "tulip",
    "tunic", "usher", "vapor", "vigil", "vinyl", "visor", "vivid", "vixen",
    "waltz", "whiff", "widow", "windy", "yacht", "yearn", "zebra",
    "zesty", "zingy", "abode", "adorn", "algae", "ankle", "anvil",
    "abyss", "amble", "azure", "balmy", "bezel", "bland", "blimp", "blurt",
    "borax", "brawl", "brine", "burly", "cabal", "caulk", "champ", "chomp",
    "civic", "cleft", "clink", "clump", "coax", "crumb", "cynic", "decal",
    "delve", "denim", "dimly", "dirge", "dowel", "drawl", "dryly", "dunce",
    "easel", "elude", "expat", "exult", "femme", "finch", "fjord", "flaky",
    "flask", "flesh", "forge", "frond", "gaunt", "glean", "gnarl", "gouge",
    "grasp", "grout", "gusto", "haunt", "hitch", "hoist", "humus", "hyper",
    "impel", "inept", "irate", "jerky", "joust", "knelt", "ladle", "latch",
    "leapt", "libel", "lilac", "linen", "lymph", "macho", "maize", "mango",
    "maple", "moose", "mulch", "naive", "nifty", "notch", "olive", "optic",
    "penal", "perch", "phony", "pleat", "pluck", "plunk", "poser", "primo",
    "prune", "qualm", "quilt", "ranch", "rebus", "renal", "rivet", "rogue",
  ];
